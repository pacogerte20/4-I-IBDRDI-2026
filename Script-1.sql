create table compritas(
id int not null auto_increment primary key,
productos varchar(50)
);

create table compritas2(
id int not null auto_increment primary key,
productos varchar(50)
);

drop table compritas2;
insert into compritas
(productos)
values
('Azucar'),
('Pan'),
...
('manzana');
  ...
  select *
  from compritas
  left join compritas2 on compritas.productos = compritas2.productos
  
  union
  
  select *
  from compritas
  right join compritas2 on compritas.productos = compritas2.productos
